...
<body>
	...
	<div class="covervid-wrapper">
	    <video class="covervid-video" playsinline autoplay muted loop controls poster="../resources/image/tabber.jpg">
	        <source src="../resources/videos/Tabber - Look At My  Like A Vampire (Official Teaser).mp4" type="video/mp4">
	        <source src="../resources/videos/Tabber - Look At My  Like A Vampire (Official Teaser).webm" type="video/webm">
	    </video>
