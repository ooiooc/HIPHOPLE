	...
	<div class="notice_wrap">
		<div class="noticebox">
			<div class="notice_title"><h1 class="catetitle">COMMUNITY</h1></div>		
				<ul class="notice_box">
					<li class="n_titlebox">
					<div class="n_cate">${view.category}</div>
						<div class="n_title">${view.title}</div>
						<div class="n_date">${view.writer}&emsp;｜&emsp;<fmt:parseDate var="writeDate" value="${view.regdate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:parseDate>
						<fmt:formatDate value="${writeDate}" pattern="yyyy년 M월 d일"></fmt:formatDate>
						&emsp;｜&emsp;조회수 ${view.viewcnt}</div>
					</li>
				</ul> <!-- notice list -->
